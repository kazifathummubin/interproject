    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            {!! Form::open(['method'=>'post','route'=>'menu.store','files'=>true,'class'=>'form-group']) !!} <br>

            {!! Form::text('name', null,['class'=>'form-control', 'placeholder'=>'name']) !!}<br>

            {!! Form::text('order', null,['class'=>'form-control', 'placeholder'=>'order']) !!}<br>
            ...
            {{--{!! Form::radio('size_id', null,['class'=>'form-control', 'placeholder'=>'Choose One']) !!}<br>--}}
                            ...
                            {!! Form::button('Create menu', ['class'=>'btn btn-outline-purple btn-lg  waves-effect waves-light','type'=>'submit']) !!}
                            {!! Form::close() !!}
