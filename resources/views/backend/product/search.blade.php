...
@section('pageTitle',$title,' List')
@section('content')
    <div class="wrapper">
                <h1 class="text-center" style="color: white;text-transform: capitalize " >
                    @php  echo str_replace($search, '<mark style="color: red">'.$search.'</mark>',$title);  @endphp List</h1>
                @if(session()->has('msg'))
                                                ...
                                                <thead>
                                                    ...
                                                    @foreach($products as $product)
                                                        <tr>
                                                            ...
                                                            <td>
                                                            @php
                                                                echo str_replace($search, '<mark style="color: red">'.$search.'</mark>',$product->sku);
                                                            @endphp
                                                            ...
                                                            @php
                                                                ...
                                                                echo str_replace($search, '<mark style="color: red">'.$search.'</mark>',$title)
                                                            @endphp
                                                            <td>
                                                                <div id="">
                                                                    @php
