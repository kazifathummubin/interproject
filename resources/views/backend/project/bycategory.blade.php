                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($projects as $project)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{asset('backend/assets/images/project')}}/{{$project->project_photo1}}" width="50px">
                                                </td>
                                                <td>
                                                    <img src="{{asset('backend/assets/images/project')}}/{{$project->project_photo2}}" width="50px">
                                                </td>
                                                <td>
                                                    <img src="{{asset('backend/assets/images/project')}}/{{$project->project_photo3}}" width="50px">
                                                </td>
                                                <td>
                                                    <img src="{{asset('backend/assets/images/project')}}/{{$project->project_photo4}}" width="50px">
                                                </td>
                                                <td>
